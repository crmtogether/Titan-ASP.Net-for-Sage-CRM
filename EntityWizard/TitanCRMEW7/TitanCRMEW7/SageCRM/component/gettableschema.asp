...
*  http://localhost/crm61/custompages/sagecrm/component/gettableschema.asp?SID=40740076948278
*/
//******************************************************************************
try{
  ...
  if (useX){
    ...
    while (!fieldrec.eof){
      ...
      if (idFieldName!=fieldx)
      {
        ...
        result+="string";  //everything is returned as a string type
        result+="</FieldType>";
        result+="<FieldCaption>"+eWare.GetTrans("ColNames",fieldx)+"</FieldCaption>";
        result+="</"+TableName+">";
      }      
      fieldrec.NextRecord();
    } 
