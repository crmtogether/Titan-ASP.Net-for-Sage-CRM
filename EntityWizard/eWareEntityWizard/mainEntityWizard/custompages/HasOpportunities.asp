...
List=eWare.GetBlock("OpportunityGrid");
List.prevURL=sURL;
...
if (Id.toString() != 'undefined') {
   ...
   Container.AddButton(eWare.Button("New", "new.gif", eWare.URL(261)+ ExtraKeys + "&Key-1="+iKey_CustomEntity+"&PrevCustomURL="+List.prevURL+"&E=**&EntityName&**", 'opportunity', 'insert'));
