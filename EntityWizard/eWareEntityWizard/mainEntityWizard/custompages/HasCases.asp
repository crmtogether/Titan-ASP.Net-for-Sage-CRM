...
if (Id.toString() != 'undefined') {
   ...
   Container.AddButton(eWare.Button("New", "new.gif", eWare.URL(282)+ ExtraKeys + "&Key-1="+iKey_CustomEntity+"&PrevCustomURL="+List.prevURL+"&E=**&EntityName&**", 'cases', 'insert'));
