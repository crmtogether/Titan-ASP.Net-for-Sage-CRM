<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wf.aspx.cs" Inherits="Wf" %>
...
<body>
    ...
    <div>
        <SageCRM:SageCRMConnection ID='SageCRMConnection' runat="server" CRMPath="http://localhost/crm" SID="16284755131459" />
            ...
            <tr valign="top" >
                ...
                <td style="width: 77%; height: 90%" valign="top" >
                    &nbsp;<SageCRM:SageCRMEntryBlock ID="SageCRMEntryBlock" runat="server" AfterSavePage="entwiz/Summary.aspx"
                        ...
                        EntryBlockName="xxxxxxxxxNewEntry" ShowWorkFlowButtons="True" WorkFlowName="entwiz Workflow" WFState="Logged" />
                    <br />
                    <br />
                    <br />
                    <br />
