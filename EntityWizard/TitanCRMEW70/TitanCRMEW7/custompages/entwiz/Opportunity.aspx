<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeFile="Opportunity.aspx.cs" Inherits="Opportunity" %>
      ...
      <table style="height: 500px; vertical-align:top" width="100%" border="0"  cellpadding="0" cellspacing="0" >
            ...
            <tr valign="top" >
                ...
                <td style="width: 77%; height: 90%" valign="top" >
                    <sagecrm:sagecrmlistblock id="SageCRMListBlock" runat="server" blocktitle="" entityname="Opportunity"
                        entitywhere="oppo_opportunityId=-1" listblock="OpportunityGrid"></sagecrm:sagecrmlistblock>
                    <br />
                    <br />
                    <br />
                    &nbsp;&nbsp;
