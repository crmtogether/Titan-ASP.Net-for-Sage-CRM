...
//  Container.AddButton(eWare.Button("Clear", "clear.gif", "javascript:document.forms.em.value='6';document.forms.submit();"));
  Container.AddButton('<A CLASS=ButtonItem ONFOCUS="if (event && event.altKey) click();" ACCESSKEY="l" HREF="javascript:document.forms.em.value=\'6\';document.forms.submit();">' +
                      '<IMG SRC="http://localhost/CRM61/img/Buttons/clear.gif" BORDER=0 ALIGN=MIDDLE></A></TD><TD>&nbsp;</TD><TD>'+
                      '<A CLASS=ButtonItem ONFOCUS="if (event && event.altKey) click();" ACCESSKEY="l" HREF="javascript:document.forms.em.value=\'6\';document.forms.submit();">C'+
