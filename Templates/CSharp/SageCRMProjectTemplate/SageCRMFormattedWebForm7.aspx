<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SageCRMFormattedWebForm7.aspx.cs" Inherits="$safeprojectname$.SageCRMFormattedWebForm7"  ValidateRequest="false" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Sage CRM</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
    <link type="text/css" rel="Stylesheet" href="color1.css" />   
